...
This analysis supports school nutrition policy decision-makers—including education ministries, school administrators, and public health agencies—by evaluating school level nutrition policy interventions. The model explicitly links actionable policy levers (canteen reforms, staff training, nutrition education) to outcomes (student health, learning, cost-efficiency), as visualized in Figure 1. Grounded in literature and policy evidence (validated in Tables 1–2), we focus on five core intervention domains (used as toggles in our model):
