...
`r round(sum(EVPI$decision_value$EVPI_do, na.rm = TRUE), 2)` million VND. A small residual uncertainty in the economic return in a minority of simulations produce
