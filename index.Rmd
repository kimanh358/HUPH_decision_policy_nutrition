...
ggplot(sim_data, aes(x = decision_value, y = health_cost_savings)) +
  geom_point(alpha = 0.2, color = "gray") +
  geom_point(data = pareto_front, color = "red", size = 2) +
  labs(
    title = "Pareto Front: Economic Return vs Health Savings (Per Simulation)",
    x = "NPV (Economic Return)",
    y = "Health Cost Savings (VND)"
  ) +
  theme_minimal()
